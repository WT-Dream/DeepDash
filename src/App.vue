  ...
  <div :class="['app-shell', { 'dsh-focused-shell': isRunning && activeView === 'dashboard' }]">
    <aside class="sidebar">
      ...
      <div class="sidebar-foot">
        ...
        <span class="app-version">DeepDash 1.0.1</span>
      </div>
    </aside>
